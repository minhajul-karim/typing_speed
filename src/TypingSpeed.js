...
export default function TypingSpeed() {
  return (
    <div className="typing_container">
      ...
      <p className="typing_container__speed">Speed <strong>0</strong> WPM</p>
      <p className="typing_container__accuracy">Accuracy <strong>0%</strong></p>
      <button className="typing_container__btn">start</button>
      <p className="typing_container__time">0s</p>
